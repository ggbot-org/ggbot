import { AccountKey, Subscription, SubscriptionPurchase, SubscriptionPurchaseKey, UpdateTime } from '@workspace/models'
...
export type PaymentAction = {
	...
	WriteSubscriptionPurchase: (arg: SubscriptionPurchaseKey & SubscriptionPurchase) => Promise<UpdateTime>
}
...
export type PaymentActionInput = {
	...
	WriteSubscriptionPurchase: Parameters<PaymentAction['WriteSubscriptionPurchase']>[0]
}
...
export type PaymentActionOutput = {
	...
	WriteSubscriptionPurchase: Awaited<ReturnType<PaymentAction['WriteSubscriptionPurchase']>>
}
