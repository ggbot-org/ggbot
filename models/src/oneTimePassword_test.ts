...
void describe("isOneTimePassword", () => {
	void test("validates input if is valid OneTimePassword", () => {
...
void describe("generateOneTimePassword", () => {
	void test("generates a OneTimePassword", () => {
