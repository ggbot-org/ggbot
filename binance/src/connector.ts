...
const apiClusters = ["https://api1.binance.com", "https://api2.binance.com", "https://api3.binance.com"];
...
export class BinanceConnector {
  ...
  constructor({ baseUrl = BinanceConnector.defaultBaseUrl }: BinanceConnectorConstructorArg) {
    this.baseUrl = baseUrl;
  }

  async request<Data>({ apiKey = "", endpoint, method, params = {} }: BinanceConnectorRequestArg) {
