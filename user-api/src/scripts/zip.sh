...
for WORKSPACE in api api-gateway arithmetic aws authentication binance binance-client cache database dflow env email-messages http infrastructure locators logging models; do
