...
for INTERNAL_DEP in api-gateway arithmetic aws binance binance-client cache database dflow env email-messages infrastructure locators models test-data type-utils; do
...
for WORKSPACE in api authentication http logging; do
