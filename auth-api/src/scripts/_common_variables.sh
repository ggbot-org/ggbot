...
EXIT_FUNCTION_NAME="ggbot2-${DEPLOY_STAGE}-exit"
EXIT_FUNCTION_LOG_GROUP_NAME=/aws/lambda/$EXIT_FUNCTION_NAME
EXIT_FUNCTION_ZIP_FILE="fileb://dist/exit.zip"

VERIFY_FUNCTION_NAME="ggbot2-${DEPLOY_STAGE}-verify"
