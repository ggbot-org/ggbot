...
for INTERNAL_DEP in api-gateway arithmetic authentication aws binance binance-client database dflow env email-messages http infrastructure locators models test-data type-utils; do
