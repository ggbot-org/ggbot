...
describe("extractBinanceSymbolsAndIntervalsFromFlow", () => {
  it("extracts symbol and interval tuples", async () => {
    ...
    const view: StrategyFlow["view"] = {
      nodes: [
        { id: "a1", text: "ETH/BTC", x: 0, y: 0, outs: [{ id: "oa1" }] },
        { id: "a2", text: "1h", x: 0, y: 0, outs: [{ id: "oa2" }] },
        { id: "a3", text: "candles", x: 0, y: 0, ins: [{ id: "ai1" }, { id: "ai2" }, { id: "ai3" }] },
        { id: "b1", text: "BTC/BUSD", x: 0, y: 0 },
        { id: "b2", text: "1d", x: 0, y: 0, outs: [{ id: "ob2" }] },
        { id: "b3", text: "candles", x: 0, y: 0, ins: [{ id: "bi1" }, { id: "bi2" }, { id: "bi3" }] },
      ],
      edges: [
  ...
  it("manages duplicates", async () => {
    ...
    const view: StrategyFlow["view"] = {
      nodes: [
        ...
        { id: "b1", text: "ETH/BTC", x: 0, y: 0, outs: [{ id: "ob1" }] },
