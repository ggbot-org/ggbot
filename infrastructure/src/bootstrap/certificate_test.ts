...
import { CertificateStatus, listCertificates, RenewalEligibility } from "@workspace/aws-acm"
...
const certificate = CertificateSummaryList?.find(({ DomainName }) => DomainName === DNS_DOMAIN)
